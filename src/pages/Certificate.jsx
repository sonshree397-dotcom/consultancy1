            ...
            <div className="relative overflow-hidden rounded-[22px] border-2 border-slate-200 bg-white p-8 md:p-10">
              ...
              <div className="relative flex flex-col gap-8">
                <div className="flex items-start justify-between gap-6">
                  <div>
                    <div className="text-xs font-semibold tracking-widest text-slate-600">GECKO WORKS NEPAL</div>
                ...
                <div className="text-xs text-slate-500">Reference No: Gecko Works Nepal-{(country || 'xx').toUpperCase()}-{selectedStudent?.id || 's1'}</div>
              </div>
            </div>
          </div>
        </div>
